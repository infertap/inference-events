...
Each fixture pairs sealed input segments with the verdict a conforming reader must reach.
The cases cover these obligations:
...
def segment(
    ...
    if version != "1.1":
        ...
        header["max_segment_secs"] = (
            start.pop("max_segment_secs", 300) if start else 300
        )
    out = [header] + records
...
def _envelope(at, msgs, sources):
    return {
        ...
        "oversized": 0,
        "unknown_types": 0,
        "events_ingested": msgs,
        "content_unresolved": 0,
        "content_bridge_entries": 0,
        "content_bridge_evicted": 0,
        "publisher_restarts": 0,
        "endpoints": [
            {
                "source": s,
                "endpoint": f"tcp://{s}:5557",
                "msgs_seen": msgs,
                "dropped": 0,
                "last_msg_at_ms": at,
            }
...
def segments_dropped(run, first, last, at):
    ...
    return {
        "kind": "segments_dropped",
        "at_ms": at,
        "incarnation": run,
        "count": last - first + 1,
        "first_seq": first,
        "last_seq": last,
        "first": f"seg-{run}-{first}.jsonl",
        "last": f"seg-{run}-{last}.jsonl",
    }
...
def audit_verdict(**per_instance):
    ...
    return {
        i: {**zero, **v, "audited": sum(v.values())} for i, v in per_instance.items()
    }
...
FIXTURES = [
    ...
    (
        ...
        [
            segment(
                RUN1,
                0,
                [heartbeat(T0, 10), store("i0", "b1", T0 + 100.0, "c1", seq=41)],
            ),
            segment(
                RUN2,
                0,
    ...
    (
        ...
        [segment(RUN1, 0, [heartbeat(T0, 10), store("i0", "b1", T0 + 100.0, "c1")])],
        {"insertions": insertions(False)},
    ),
    (
    ...
    (
        ...
        [
            ...
            segment(
                ...
                [
                    heartbeat(
                        T0 + 200.0, 10, source="i1", reuse_reporting="unlabelled"
                    ),
    ...
    (
        ...
        [
            segment(
                ...
                [
                    store("i0", "b1", T0, "c1"),
                    evict("i0", "b1", T0 + 100.0, "c1"),
                    store("i0", "b1", T0 + 200.0, "c1"),
                    evict("i0", "b1", T0 + 300.0, "c1"),
                ],
            )
        ],
    ...
    (
        ...
        [
            segment(
                ...
                [
                    store("i0", "b1", T0, "c1"),
                    evict("i0", "b1", T0 + 100.0, "WRONG"),
                    store("i1", "b1", T0, "c1"),
                    evict("i1", "b1", T0 + 100.0, "c1"),
                ],
            )
        ],
    ...
    (
        ...
        [
            segment(
                ...
                [
                    store("i0", "b1", T0, "c1"),
                    evict("i0", "b1", T0 + 100.0),
                    store("i0", "b2", T0 + 200.0),
                    evict("i0", "b2", T0 + 300.0),
                ],
            )
        ],
    ...
    (
        ...
        [
            segment(
                RUN1,
                0,
                [store("i0", "b1", T0, "c1"), store("i0", "b2", T0 + 10.0, "c2")],
            )
        ],
    ...
    (
        ...
        [
            segment(
                RUN1,
                0,
                [store("i0", "b1", T0, "c1"), store("i1", "b2", T0 + 10.0, "c2")],
            )
        ],
    ...
    (
        ...
        [
            segment(
                ...
                [
                    heartbeat(
                        T0 + 1_000.0, 5, canary="c0ffee11c0ffee11c0ffee11c0ffee11"
                    ),
    ...
    (
        ...
        {"staleness": {RUN1: "live"}, "audit": audit_verdict(i0={"agreed": 1})},
    ),
    (
    ...
    (
        ...
        [
            segment(
                ...
                [
                    identity_refused(
                        T0 + 500_000.0, "i0", 5, T0 + 10_000.0, T0 + 20_000.0
                    ),
            ...
            "holder_register": [
                {
                    ...
                    "dp_rank": 0,
                    "group_idx": 0,
                    "span_ms": [T0 + 10_000.0, T0 + 20_000.0],
                ...
                },
                {
                    ...
                    "dp_rank": 0,
                    "group_idx": 0,
                    "span_ms": [T0 + 30_000.0, T0 + 40_000.0],
                    "register": "none",
                },
            ]
        },
    ...
    (
        ...
        [
            segment(
                ...
                [
                    identity_refused(
                        T0 + 35_000.0, "i0", 2, T0 + 10_000.0, T0 + 20_000.0
                    ),
                    store("i0", "b1", T0 + 12_000.0),
                ],
            )
    ...
    (
        ...
        {
            "absence": {
                "span_ms": [T0 - 300_000.0, T0 + 180_000.0],
                "register": "lower_bound",
            }
        },
    ),
    ...
    (
        ...
        [
            ...
            segment(
                ...
                [
                    agent_start(
                        T0 + 400_000.0, heartbeat_secs=300, max_segment_secs=600
                    ),
    ...
    (
        ...
        [
            ...
            segment(
                RUN2, 1, [heartbeat(T0 + 400_000.0, 10), heartbeat(T0 + 460_000.0, 20)]
            ),
        ],
        {"uncovered": {"i0": [[T0 + 120_000.0, T0 + 400_000.0]]}},
    ),
    (
        ...
        [
            ...
            segment(
                ...
                [
                    agent_start(
                        T0 + 150_000.0, heartbeat_secs=300, max_segment_secs=600
                    ),
    ...
    (
        ...
        [
            segment(
                RUN1,
                1,
                [heartbeat(T0 + 60_000.0, 10), heartbeat(T0 + 120_000.0, 20)],
                version="1.1",
            ),
            horizon_producer(),
        ],
